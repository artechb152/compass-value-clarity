      ...
      <div className="p-4 max-w-2xl mx-auto space-y-6">
        <div className="py-6">
          <div className="flex items-center justify-center relative">
            <Button variant="ghost" size="icon" onClick={() => navigate("/intro")} className="absolute right-0 hover:bg-primary [&:hover_svg]:text-white" aria-label="חזרה למסך הפתיחה">
              <ArrowRight className="h-5 w-5 text-muted-foreground" />
            </Button>
            <h1 className="text-3xl font-bold text-primary">רוח צה״ל</h1>
          </div>
          <p className="text-muted-foreground text-center mt-1">התנגשות בין ערכים</p>
        </div>
