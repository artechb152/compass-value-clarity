      ...
      <header className="bg-primary text-primary-foreground px-4 py-2 flex items-center justify-between sticky top-0 z-40 shadow-md">
        <TooltipProvider delayDuration={300}>
          <Tooltip>
            ...
            <TooltipContent side="bottom" align="end" sideOffset={4} className="px-2 py-0.5"><p className="text-[10px]">מסך הבית</p></TooltipContent>
          </Tooltip>
        </TooltipProvider>
        <div className="flex items-center gap-1">
          <TooltipProvider delayDuration={300}>
            <Tooltip>
              ...
              <TooltipContent side="bottom" align="start" sideOffset={4} className="px-2 py-0.5"><p className="text-[10px]">{theme === 'dark' ? 'מצב יום' : 'מצב לילה'}</p></TooltipContent>
            </Tooltip>
          </TooltipProvider>
          {isAdmin && (
          ...
          <TooltipProvider delayDuration={300}>
            <Tooltip>
              ...
              <TooltipContent side="bottom" align="start" sideOffset={4} className="px-2 py-0.5"><p className="text-[10px]">התנתק</p></TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
      </header>
